...
import {FlatList, Text, View, Image, Touchable, TouchableOpacity} from 'react-native';
        ...
        if(!querySnapshot.empty)
        {
          querySnapshot.forEach(documentSnapshot => {
           ...
           // console.log('thread data',documentSnapshot.data().threadId);
            ...
            navigation.navigate('ChatScreen',{item,threadId})
         });
          ...
          // navigation.navigate('ChatScreen',{item,id})
          }
        }
