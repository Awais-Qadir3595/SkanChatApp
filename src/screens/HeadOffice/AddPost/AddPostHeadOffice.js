...
const AddPostHeadOffice = props => {
  ...
  const renderSchools = ({ item, index }) => {
    ...
    <View style={styles.main}>
      ...
      <View style={styles.body}>
        ...
        <Bold
          ...
          label="Please select the Schools with whom you want to share the post"
        />
        <FlatList
          ...
          columnWrapperStyle={{
            ...
            borderBottomWidth: 0.5, borderBottomColor: 'lightgray', paddingBottom: 5
          }}
          data={Schools}
...
export default AddPostHeadOffice;
